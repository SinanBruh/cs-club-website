import { c as createAstro, a as createComponent, r as renderTemplate, b as renderComponent, m as maybeRenderHead, d as addAttribute, e as renderHead, f as renderSlot, s as spreadAttributes } from '../astro.6cc394b1.mjs';
import 'html-escaper';
/* empty css                           *//* empty css                        */
...
<footer class="p-4 text-(neutral-400 center)">
  ...
  <div class="flex gap-6 items-center justify-center text-sm pt-2">
    <a href="/rss.xml" class="flex flex-col gap-y-0.5 items-center text-neutral-400 hover:(no-underline text-neutral-200) transition-colors duration-300">
    ...
    <a href="/sitemap-index.xml" class="flex flex-col gap-y-0.5 items-center text-neutral-400 hover:(no-underline text-neutral-200) transition-colors duration-300">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <nav class="flex gap-3 astro-3EF6KSR2">
    ...
    ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/", "class": "astro-3EF6KSR2" }, { "default": ($$result2) => renderTemplate`Link` })}
    ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/", "class": "astro-3EF6KSR2" }, { "default": ($$result2) => renderTemplate`FAQ` })}
    ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "https://github.com/nexxeln", "target": "_blank", "class": "astro-3EF6KSR2" }, { "default": ($$result2) => renderTemplate`GitHub` })}
  </nav>
</header>`;
  ...
  <body>
    ...
    <main class="text-lg text-neutral-200">
      ...
      <p>
        ...
        time I like to write <a href="https://github.com/Nim1com">code</a> and practice <a href="https://en.wikipedia.org/wiki/Cardistry" target="_blank">cardistry</a>. I also like listening to music and going on cycling trips with
        friends.
      </p>
      <br>
      <br>
